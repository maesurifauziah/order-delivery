                    ...
                    <div class="card-header d-flex p-0">
                        <ul class="nav nav-pills p-2">
                            <li class="nav-item mr-2">
                                <a href="#" onclick="add_form()" class="btn btn-primary btn-sm" id="add"><i
                                        class="fa fa-plus"></i>
                                    Add</a>
                            </li>
                        </ul>
...
<?php $this->load->view('master_kategori_barang_modal'); ?>
<?php $this->load->view('master_kategori_barang_js'); ?>