<div class="modal fade text-xs" id="modal-form-register" role="dialog">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title-form-register">Form Buat Akun</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <?php echo form_open('', array('id' => 'form-register', 'role' => 'form')); ?>
                    <input type="hidden" name="userid" id="userid" />
                    <input type="hidden" name="user_group" id="user_group" value="0002"/>
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control form-control-sm text-xs" name="alamat" id="alamat" rows="2"></textarea>
